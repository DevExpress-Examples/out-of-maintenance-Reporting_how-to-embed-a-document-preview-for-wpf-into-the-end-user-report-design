...
Namespace E3465
    Friend Class BarButtonTabPage
        ...
        Private wpfReportPreviewUserControl As E3465.WPF.WpfReportPreviewUserControl
        Private Caption As String
        Private reportCommand As ReportCommand

        Public Sub New(ByVal wpfReportPreviewUserControl As E3465.WPF.WpfReportPreviewUserControl, ByVal Caption As String, ByVal button As BarButtonItem, ByVal reportCommand As ReportCommand)

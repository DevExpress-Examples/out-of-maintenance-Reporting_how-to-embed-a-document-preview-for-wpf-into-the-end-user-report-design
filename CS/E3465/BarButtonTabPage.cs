...
namespace E3465{
    class BarButtonTabPage : XtraTabControl.TabPage {
        ...
        private E3465.WPF.WpfReportPreviewUserControl wpfReportPreviewUserControl;
        private string Caption;
        private ReportCommand reportCommand;

        public BarButtonTabPage(E3465.WPF.WpfReportPreviewUserControl wpfReportPreviewUserControl, string Caption, BarButtonItem button, ReportCommand reportCommand)
